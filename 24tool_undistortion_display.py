...
if __name__ == "__main__":
    ...
    # 定义图像文件夹路径
    images_directory_name = f'saved_images_0{index}'
    images_directory_path = os.path.join(base_directory, 'data', 'saved_images', images_directory_name)
